...
presto_tokens = (
    ...
    'FALSE', 'FETCH', 'FIRST_VALUE', 'FLOAT', 'FOR', 'FORCE', 'FOREIGN', 'FROM', 'FULLTEXT',
    'GENERATED', 'GRANT', 'GROUP', 'GROUPS', 
    'HAVING', 'HIGH_PRIORITY', 'HOUR_MICROSECOND', 'HOUR_MINUTE', 'HOUR_SECOND', 
    'IF', 'IGNORE', 'IN', 'INDEX', 'INFILE', 'INNER', 'INOUT', 'INTEGER', 'INTERSECT', 
    'INTERVAL', 'INTO', 'OUTFILE', 'IS', 'INSERT', 'INT', 'INT1', 'INT2', 'INT3', 
    'INT4', 'INT8', 'ITERATE', 
    'JOIN', 
    'KEY', 'KEYS', 'KILL', 
    ...
    'OF', 'ON', 'OPTIMIZE', 'OPTION', 'OPTIONALLY', 'OR', 'ORDER', 'OUT', 'OUTER', 'OVER', 
    ...
    'USE', 'USING', 'UTC_DATE', 'UTC_TIMESTAMP', 'UTC_TIME', 'VALUES', 
...
presto_nonreserved = (
    ...
    'FIELDS', 'FILE','FIRST','FLUSH','FOR', 'FORMAT', 'FOUND', 'FULL', 'FUNCTION', 
    'GENERAL','GLOBAL', 'GRANTS', 
    'HANDLER', 'HASH', 'HELP','HOSTS','HOUR', 
    'IDENTIFIED', 'IMPORT', 'INDEXES', 'INSERT_METHOD', 'INSTANCE', 'INVOKER',
    'INVISIBLE', 'IO', 'IPC', 'ISOLATION', 'ISSUER', 'ITERATE', 
    'JSON', 
    'KEY_BLOCK_SIZE',  
    ...
    'OF', 'OFF', 'OFFSET','ON_DUPLICATE', 'ONLINE', 'ONLY', 'OPEN', 'OPTIONAL', 
    ...
    'UNCOMMITTED', 'UNDEFINED', 'UNDO', 'UNDO_BUFFER_SIZE', 'UNINSTALL', 'UNKNOWN','UNLOCK', 'USER'
    'USER_RESOURCES',
    'VALIDATION', 'VALUE', 'VALUES', 'VARIABLES', 
    'WAIT', 'WARNINGS', 'WEEK', 'WEIGHT_STRING', 'WITHOUT', 'WORK', 'WRAPPER', 'WRITE', 
    'X509', 'XA', 'XID', 'XML', 'XOR',
    'YEAR', 
    'ZEROFILL'
)
