...
presto_tokens = (
    ...
    'CONFIDENCE', 'XOR','OR', 'AND', 'IN', 'NOT', 'NO', 'EXISTS', 'BETWEEN', 'LIKE', 'IS', 'NULL',
    ...
    'REPLICA_NUM', 'USE_BLOOM_FILTER', 'TABLET_SIZE', 'PCTFREE', 'NOWAIT', 'WAIT', 'IGNORE', 'REGEXP','RLIKE','LOCK', 'SHARE',
    'MODE', 'FORCE', 'INDEX', 'DECIMAL', 'CHARACTER','DIV','MOD'
)
