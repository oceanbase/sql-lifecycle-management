...
class MyTestCase(unittest.TestCase):
    def test_get_filter_column(self):
        sql = (
            "select name,max(age),count(*),avg(age) from blog b join a on a.id = blog.id "
    ...
    def test_get_filter_column2(self):
        ...
        assert table_list == [
            {
                'table_name': 'tars_sqldiag_all',
                'alias': '',
                'filter_column_list': [
                    {'column_name': 'diag_type', 'opt': 'in'},
            ...
            {
                'table_name': 'tars_obdeploy_group',
                'alias': '',
                'filter_column_list': [
                    {'column_name': 'deploy_group', 'opt': '='},
                    {'column_name': 'cluster', 'opt': '='},
                ],
            },
        ]
        assert projection_column_list == [
            'cluster',
            'tenant_name',
            'sql_id',
            'diag_type',
        ...
        assert order_list == [
            {'ordering': 'asc', 'column_name': 'cluster'},
    ...
    def test_between(self):
        ...
        assert table_list == [
            {
                'table_name': 'table_850d',
                'alias': '',
                'filter_column_list': [
                    {'column_name': 'period', 'opt': 'between'},
